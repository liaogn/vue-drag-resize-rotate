...
// CONCATENATED MODULE: ./src/vdr/index.vue?vue&type=template&id=0b7fff82&
  ...
  methods: {
    ...
    stickMove: function stickMove(ev) {
      ...
      this.RectFliper.borderSignsWatcher(mousePoint, function (isDegFlip, sign) {
        _this.flipSign = sign;
        if (isDegFlip) _this.rotate += _this.flipSign === '-' ? -180 : 180;
        _this.$emit('fliped', _this.posData, ev);
