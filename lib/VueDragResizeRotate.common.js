...
// CONCATENATED MODULE: ./node_modules/_cache-loader@2.0.1@cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"514a6e5c-vue-loader-template"}!./node_modules/_vue-loader@15.9.2@vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/_cache-loader@2.0.1@cache-loader/dist/cjs.js??ref--0-0!./node_modules/_vue-loader@15.9.2@vue-loader/lib??vue-loader-options!./src/vdd/index.vue?vue&type=template&id=0e256aa2&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vdr",class:{ 'vdr-active': _vm.active && _vm.activeable, 'vdr-not-active': !_vm.activeable },style:(_vm.style),on:{"click":function($event){$event.stopPropagation();},"mousedown":function($event){$event.stopPropagation();$event.preventDefault();return _vm.bodyDown($event)}}},[(_vm.active && _vm.activeable)?[_vm._l((_vm.sticks),function(stick,stickIndex){return _c('span',{key:stickIndex,staticClass:"vdr-stick",class:("vdr-stick-" + stick),style:({ width: (_vm.stickSize + "px"), height: (_vm.stickSize + "px") }),on:{"mousedown":function($event){$event.stopPropagation();$event.preventDefault();return _vm.stickDown($event, stick)}}})}),_c('div',{staticClass:"vdr-stick vdr-rotate",style:({ width: ((_vm.stickSize * 1.5) + "px"), height: ((_vm.stickSize * 1.5) + "px") }),on:{"mousedown":function($event){$event.stopPropagation();$event.preventDefault();return _vm.rotateDown($event)}}},[_c('span',{staticClass:"vdr-stick-line",on:{"mousedown":function($event){$event.stopPropagation();$event.preventDefault();}}})])]:_vm._e(),_c('div',{staticClass:"vdr-slot",attrs:{"bg":_vm.bg}},[_vm._t("default")],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/vdd/index.vue?vue&type=template&id=0e256aa2&
...
/* harmony default export */ var vddvue_type_script_lang_js_ = ({
  ...
  computed: {
    style: function style() {
      return {
        ...
        transform: "rotateZ(".concat(Math.round(this.rotate), "deg)")
      };
    },
  ...
  methods: {
    ...
    init: function init() {
      ...
      this.right = this.parentWidth - this.width - this.left; // 鼠标、元素位置信息初始化
    ...
    bodyDown: function bodyDown(ev) {
      ...
      this.bodyStartPos.my = ev.pageY; // 记录开始元素位置
    ...
    stickDown: function stickDown(ev, stick) {
      if (!this.activeable) return;
      this.stickDrag = true; // 记录当前拖拽的stick

      this.currentStick = stick; // 记录开始时鼠标位置

      this.bodyStartPos.mx = ev.pageX;
      this.bodyStartPos.my = ev.pageY; // 计算开始时元素right、bottom位置信息
    ...
    rotateDown: function rotateDown(ev) {
      if (!this.activeable) return; // 旋转目标，即当前需要进行旋转的元素

      var target = ev.target.parentNode; // 获取目标位置大小信息，用于计算旋转元素的中心点

      var ract = target.getBoundingClientRect();
      var left = ract.left,
          top = ract.top,
          width = ract.width,
          height = ract.height;
  ...
  watch: {
    ...
    width: function width(newVal) {
      if (newVal < MAXSIZE) {
        ...
        if (this.lock) {
          this.height = Math.round(MAXSIZE / this.whRatio);
        }
      }
    },
    height: function height(newVal) {
      if (newVal < MAXSIZE) {
        ...
        if (this.lock) {
          this.width = Math.round(MAXSIZE * this.whRatio);
        }
      }
    },
    w: function w(value) {
